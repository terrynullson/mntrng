...
[2026-03-03] [HUB-DARK-ORBS-RU-007]
Agent: FrontendAgent
Commit: pending
Summary:
- /hub: орбы переведены в 2 слоя глубины (3 дальних, 2 ближних) с контролируемым хаосом — каждые 3–7 с выбирают новую точку, избегая центра и сильного слипания, без setState на кадр (только rAF + transform).
- /hub: палитра орбов обновлена под «полярную ночь» (2 холодных розово‑пурпурных, 1 сиреневый, 2 ice‑cyan/violet) и ослаблена в light для «морозного утра».
- /hub: названия модулей приведены к единому RU (Смотреть, Мониторинг, Управление, Отчёты) при сохранении существующих маршрутов.
Notes:
Живой фон читается под стеклянными карточками, на статичном кадре видно несколько орбов; prefers-reduced-motion оставлен статичным.

[2026-03-03] [HUB-GLASS-NOISE-008]
Agent: FrontendAgent
Commit: pending
Summary:
- /hub: карточки модулей доведены до «реального стекла» — усилен верхний inner-highlight в dark и добавлен едва заметный micro-noise/texture слой через soft-light градиенты.
