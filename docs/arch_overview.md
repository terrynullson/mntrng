...
Исторические материалы по целевой микро-сервисной архитектуре и расширенным audit-планам перенесены в `_archive/docs/` и не являются source-of-truth для текущего runtime.
