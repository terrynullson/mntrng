...
export function ThemeToggleButton() {
  ...
  return (
    <>
      {/* Lightbulb theme toggle: https://toggles.dev/lightbulb */}
      <button
        type="button"
        className="theme-toggle"
        title={isNight ? "Переключить на светлую тему" : "Переключить на тёмную тему"}
        aria-label={isNight ? "Переключить на светлую тему" : "Переключить на тёмную тему"}
        onClick={toggleTheme}
      >
        <svg
      ...
      {/* Previous theme switcher (dottereldesign / CodePen) — закомментирован
      <button
        type="button"
      ...
      >
        ...
        <div className="cloud-ball cloud-ball-left" aria-hidden="true" />
        <div className="cloud-ball cloud-ball-middle" aria-hidden="true" />
        <div className="cloud-ball cloud-ball-right" aria-hidden="true" />
        <div className="cloud-ball cloud-ball-top" aria-hidden="true" />
